...
*/
# 128 "/Users/s1oly/Documents/GitHub/EcoBot/EcoBot/EcoBot.ino"
...
void forward()
{
  ...
  front_leftmotor.run(1); //rotate the motor clockwise
  front_rightmotor.setSpeed(200); //Define maximum velocity
  front_rightmotor.run(1); //rotate the motor clockwise
  back_leftmotor.setSpeed(200); //Define maximum velocity
  back_leftmotor.run(1); //rotate the motor clockwise
  back_rightmotor.setSpeed(200); //Define maximum velocity
  back_rightmotor.run(1); //rotate the motor clockwise
}

void back()
{
  front_leftmotor.setSpeed(200); //Define maximum velocity
  front_leftmotor.run(2); //rotate the motor clockwise
  front_rightmotor.setSpeed(200); //Define maximum velocity
  front_rightmotor.run(2); //rotate the motor clockwise
  back_leftmotor.setSpeed(200); //Define maximum velocity
  back_leftmotor.run(2); //rotate the motor clockwise
  back_rightmotor.setSpeed(200); //Define maximum velocity
  back_rightmotor.run(2); //rotate the motor clockwise
}

void left()
{
  front_leftmotor.setSpeed(200); //Define maximum velocity
  front_leftmotor.run(2); //rotate the motor anti-clockwise
  front_rightmotor.setSpeed(200); //Define maximum velocity
  front_rightmotor.run(2); //rotate the motor anti-clockwise
  back_leftmotor.setSpeed(200); //Define maximum velocity
  back_leftmotor.run(1); //rotate the motor clockwise
  back_rightmotor.setSpeed(200); //Define maximum velocity
  back_rightmotor.run(1); //rotate the motor clockwise
...
void right()
{
  ...
  front_rightmotor.run(1); //rotate the motor clockwise
  back_leftmotor.setSpeed(200); //Define maximum velocity
  back_leftmotor.run(2); //rotate the motor anti-clockwise
  back_rightmotor.setSpeed(200); //Define maximum velocity
  back_rightmotor.run(2); //rotate the motor anti-clockwise
}
...
void Stop()
{
  ...
  front_rightmotor.setSpeed(0); //Define minimum velocity
  front_rightmotor.run(4); //rotate the motor clockwise
  back_leftmotor.setSpeed(0); //Define minimum velocity
